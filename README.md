...
* Modélisation statistique : Régressions, K-means, prévisions temporelles (moyennes mobiles), SARIMA.
* Gestion des bases de données : Extraction et requêtage avancé en SQL avec SQLiteStudio
